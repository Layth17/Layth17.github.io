...
> **Source**: <https://www.youtube.com/watch?v=c3Cn4xYfxJY&t=453s> (in progress, 12:19:34)
...
- **Network Access Control Lists** (NACLs)
  ...
  - Operates at the subnet level with allow/deny rules
- **Security Groups** (SG)
  - Acts as a `stateful` virtual firewall for computer within a VPC
